const benefitData = {
  ssi: {
    ...
    heroSubtext: "Fast, free payment dates for SSI, SSDI, and Social Security benefits in one clean dashboard.",
    nextPayment: "May 1, 2026",
    todayStatus: "Today: No payment scheduled",
    whyTitle: "Why Two Payments Sometimes Happen",
    whyText: "When the 1st falls on a weekend or holiday, SSI payments may arrive early.",
    whyList: ["June payment → May 29", "July payment → July 1"],
    upcomingTitle: "Upcoming Payments",
    payments: ["May 1, 2026", "May 29, 2026", "July 1, 2026", "August 1, 2026"]
  },
  ssdi: {
    heroTitle: "Find Your SSDI Payment Date Instantly",
    heroSubtext: "Track upcoming SSDI deposit dates based on the regular monthly payment schedule.",
    nextPayment: "May 13, 2026",
    todayStatus: "Today: No SSDI payment scheduled",
    whyTitle: "How SSDI Payment Dates Work",
    whyText: "SSDI payments are usually based on birth date and sent on Wednesdays.",
    whyList: ["Birth date 1st–10th → 2nd Wednesday", "Birth date 11th–20th → 3rd Wednesday", "Birth date 21st–31st → 4th Wednesday"],
    upcomingTitle: "Upcoming SSDI Payments",
    payments: ["May 13, 2026", "May 20, 2026", "May 27, 2026", "June 10, 2026"]
  },
  retirement: {
    heroTitle: "Find Your Social Security Payment Date",
    heroSubtext: "See upcoming retirement benefit payment dates in a simple, easy-to-read view.",
    nextPayment: "May 13, 2026",
    todayStatus: "Today: No retirement payment scheduled",
    whyTitle: "How Retirement Benefit Dates Are Scheduled",
    whyText: "Most retirement benefits are paid based on your birth date unless you receive both SSI and Social Security.",
    whyList: ["1st–10th → 2nd Wednesday", "11th–20th → 3rd Wednesday", "21st–31st → 4th Wednesday"],
    upcomingTitle: "Upcoming Retirement Payments",
    payments: ["May 13, 2026", "May 20, 2026", "May 27, 2026", "June 10, 2026"]
  },
  survivor: {
    heroTitle: "Find Your Survivor Benefit Payment Date",
    heroSubtext: "Check survivor benefit payment timing using the same Social Security schedule.",
    nextPayment: "May 20, 2026",
    todayStatus: "Today: No survivor payment scheduled",
    whyTitle: "How Survivor Benefit Dates Work",
    whyText: "Survivor benefits generally follow the Social Security payment schedule tied to eligibility and timing rules.",
    whyList: ["Most payments follow Wednesday schedules", "Timing may vary for some combined benefit cases"],
    upcomingTitle: "Upcoming Survivor Payments",
    payments: ["May 20, 2026", "May 27, 2026", "June 10, 2026", "June 17, 2026"]
  }
};
